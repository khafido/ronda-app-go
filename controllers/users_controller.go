...
func (server *Server) Register(w http.ResponseWriter, r *http.Request) {
	...
	responses.JSON(w, http.StatusCreated, map[string]string{"status":"Success Registered"})
}
...
func (server *Server) UpdateUser(w http.ResponseWriter, r *http.Request) {
	...
	responses.JSON(w, http.StatusOK, map[string]string{"status":"Success Updated User"})
}
...
func (server *Server) DeleteUser(w http.ResponseWriter, r *http.Request) {
	...
	responses.JSON(w, http.StatusCreated, map[string]string{"status":"Success Deleted"})
}
